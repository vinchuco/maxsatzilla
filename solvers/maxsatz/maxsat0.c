...
/* based on maxsatz17, remove rules 3, 4, 5, 6
 */

/*based on maxsatz9bis, remove CUC and binary resolution rules
 */
...
int lookahead() {
  ...
  while ((clause=my_unitclause_process())!=NO_CONFLICT) {
    conflict++;
