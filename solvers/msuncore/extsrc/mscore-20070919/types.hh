...
class PtrHash {
public:
  size_t operator()(const void* ptr) const { return (unsigned int)ptr; }
};
...
class IntHash {
public:
  size_t operator()(int val) const { return (unsigned int)val; }
};
...
typedef IntKeyMap<int> Int2IntMap;        // Int 2 Int map
