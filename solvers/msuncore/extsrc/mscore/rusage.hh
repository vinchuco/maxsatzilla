...
namespace RUSAGE {
  ...
  static inline void print_cpu_time(char* msg, ostream& outs=std::cout);
  static inline void print_mem_used(char* msg, ostream& outs=std::cout);
}
...
static inline void RUSAGE::print_cpu_time(char* msg, ostream& outs)
{
  outs << msg << ": "<< RUSAGE::read_cpu_time() << endl;
}

static inline void RUSAGE::print_mem_used(char* msg, ostream& outs)
{
