...
template <class T, class LessThan>
void verifyUnique(T* array, int& size, LessThan lt)
{
    int         i, j;
    T           last;
...
template <class T> static inline void verifyUnique(T* array, int& size) {
    sortUnique(array, size, LessThan_default<T>()); }
...
template <class T> void verifyUnique(vec<T>& v) {
    sortUnique(v, LessThan_default<T>()); }
